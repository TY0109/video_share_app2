    ...
    describe 'search' do
      context '満たすデータが存在する場合' do
        ...
        context 'タイトルが満たす場合' do
          ...
          it 'タイトル「テスト動画1月」を含む配列を返すこと' do
            expect(Video.search(title_like: 'テスト動画1月')).to include(video_jan_public_owner)
          end
        end
        ...
        context '動画投稿者を満たす場合' do
          ...
          it '動画投稿者「オ」を含まない配列を返さないこと' do
            expect(Video.search(user_name: 'オ')).to_not include(video_mar_public_staff, video_apr_private_staff, video_may_public_staff1)
          end
        end
      ...
      context '満たすデータが存在しない場合' do
        ...
        context '公開範囲、動画投稿者どちらかのみ満たす場合' do
          ...
          it '動画投稿者のみ満たす場合、空の配列を返すこと' do
            expect(Video.search(range: 'false', user_name: 'スタッフ1')).to be_empty
          end
        end
        context 'タイトル、公開期間、公開範囲いずれかのみ満たす場合' do
          it 'タイトルのみ満たす場合、空の配列を返すこと' do
            expect(Video.search(title_like: 'テスト動画1月', open_period_from: '2023-06-01T00:00',
               open_period_to: '2023-01-31T23:58', range: 'false')).to be_empty
          end
          it '公開期間のみ満たす場合、空の配列を返すこと' do
            expect(Video.search(title_like: 'テスト動画10月', open_period_from: '2023-01-01T00:00',
          ...
          it 'タイトル、公開期間のみ満たす場合、空の配列を返すこと' do
            expect(Video.search(title_like: 'テスト動画1月', open_period_from: '2023-01-01T00:00',
               open_period_to: '2023-01-31T23:59', range: 'false')).to be_empty
          end
        ...
        context '公開期間、公開範囲、動画投稿者いずれかのみ満たす場合' do
          it '公開期間のみ満たす場合、空の配列を返すこと' do
            expect(Video.search(open_period_from: '2023-01-01T00:00', open_period_to: '2023-01-31T23:59',
               range: 'false', user_name: 'オーナー10')).to be_empty
          end
          it '公開範囲のみ満たす場合、空の配列を返すこと' do
            expect(Video.search(open_period_from: '2023-06-01T00:00', open_period_to: '2022-12-31T23:59',
